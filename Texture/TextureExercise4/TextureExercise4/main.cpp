...
int main(int argc, const char * argv[]) {
    ...
    //load shader
    Shader shader("/Users/focus/Downloads/OpenGLForThesis/Texture/TextureExercise4/TextureExercise4/texture.vs",
                  "/Users/focus/Downloads/OpenGLForThesis/Texture/TextureExercise4/TextureExercise4/texture.fs");
    float vertices[] = {
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        shader.setFloat("intensity", mixValue);
        printf("intensity = %f.\n", intensity);
